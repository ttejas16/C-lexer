...
Token* lexer_scan(Lexer *lexer)
{
    ...
    // printf("Found Id [%s] at %lu at line %lu", token_value, start, lexer->line);
    return token;
}
...
const char* get_token_name(TokenType type){
    switch (type)
    {
        ...
        case TOKEN_L_CURLY_BRACE: return "TOKEN_L_CURLY_BRACE";
        case TOKEN_R_CURLY_BRACE: return "TOKEN_R_CURLY_BRACE";
